    ...
    public partial class DbInit : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Recruiters", t => t.FromId)
                ...
                .ForeignKey("dbo.Developers", t => t.ToId)
                .Index(t => t.FromId)
                .Index(t => t.ToId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.JobOffers", "ToId", "dbo.Developers");
            ...
            DropForeignKey("dbo.JobOffers", "FromId", "dbo.Recruiters");
            ...
            DropIndex("dbo.JobOffers", new[] { "ToId" });
            DropIndex("dbo.JobOffers", new[] { "FromId" });
